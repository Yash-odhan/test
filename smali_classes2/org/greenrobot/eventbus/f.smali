...
.field private final q:Lorg/greenrobot/eventbus/c;
...
.method protected constructor <init>(Lorg/greenrobot/eventbus/c;Landroid/os/Looper;I)V
    ...
    iput-object p1, p0, Lorg/greenrobot/eventbus/f;->q:Lorg/greenrobot/eventbus/c;

    iput p3, p0, Lorg/greenrobot/eventbus/f;->p:I

    new-instance p1, Lorg/greenrobot/eventbus/k;

    invoke-direct {p1}, Lorg/greenrobot/eventbus/k;-><init>()V

    iput-object p1, p0, Lorg/greenrobot/eventbus/f;->o:Lorg/greenrobot/eventbus/k;
...
.method public a(Lorg/greenrobot/eventbus/q;Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object p2, p0, Lorg/greenrobot/eventbus/f;->o:Lorg/greenrobot/eventbus/k;

    invoke-virtual {p2, p1}, Lorg/greenrobot/eventbus/k;->a(Lorg/greenrobot/eventbus/j;)V

    iget-boolean p1, p0, Lorg/greenrobot/eventbus/f;->r:Z

    if-nez p1, :cond_1

    const/4 p1, 0x1

    iput-boolean p1, p0, Lorg/greenrobot/eventbus/f;->r:Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :cond_0
    iget-object v2, p0, Lorg/greenrobot/eventbus/f;->o:Lorg/greenrobot/eventbus/k;
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lorg/greenrobot/eventbus/f;->q:Lorg/greenrobot/eventbus/c;
    ...
    iget v4, p0, Lorg/greenrobot/eventbus/f;->p:I
