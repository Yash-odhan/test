...
# instance fields
.field private final transient q:Lnet/time4j/tz/q;

.field private final transient r:Ljava/util/List;
...
.field private final transient s:Ljava/util/concurrent/ConcurrentMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final transient t:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lnet/time4j/tz/q;",
...
.field private final transient u:Z
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v2, v0, v1, v3}, Lnet/time4j/f1/a0;->s(JLnet/time4j/f1/a0;)J
    ...
    sput v0, Lnet/time4j/tz/model/j;->p:I
...
.method constructor <init>(Lnet/time4j/tz/q;Ljava/util/List;Z)V
    ...
    iput-object v0, p0, Lnet/time4j/tz/model/j;->s:Ljava/util/concurrent/ConcurrentMap;
    ...
    :cond_0
    sget-object p3, Lnet/time4j/tz/model/k;->o:Lnet/time4j/tz/model/k;
    ...
    iput-boolean p3, p0, Lnet/time4j/tz/model/j;->u:Z

    invoke-virtual {p1}, Lnet/time4j/tz/q;->h()J
    ...
    invoke-virtual {p1}, Lnet/time4j/tz/q;->p()I

    move-result v0

    invoke-virtual {p3}, Lnet/time4j/tz/q;->k()I
    ...
    :goto_1
    iput-object v2, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v3

    iput-object v3, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    iput-object p1, p0, Lnet/time4j/tz/model/j;->t:Ljava/util/List;
...
.method private static m(JLnet/time4j/tz/q;Ljava/util/List;)Lnet/time4j/tz/q;
    ...
    invoke-virtual/range {p2 .. p2}, Lnet/time4j/tz/q;->h()J
...
.method private static p(Lnet/time4j/tz/model/d;II)J
    ...
    invoke-virtual {p1, p0}, Lnet/time4j/f0;->z0(Lnet/time4j/g0;)Lnet/time4j/h0;

    move-result-object p0

    invoke-static {p2}, Lnet/time4j/tz/p;->w(I)Lnet/time4j/tz/p;
    ...
    invoke-virtual {p0}, Lnet/time4j/a0;->z()J
...
.method private q(I)Ljava/util/List;
    ...
    iget-object v3, v0, Lnet/time4j/tz/model/j;->s:Ljava/util/concurrent/ConcurrentMap;
    ...
    iget-object v4, v0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;
    ...
    iget-object v6, v0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    iget-object v7, v0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    iget-object v8, v0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    sget v4, Lnet/time4j/tz/model/j;->p:I

    if-gt v1, v4, :cond_1

    iget-boolean v1, v0, Lnet/time4j/tz/model/j;->u:Z

    if-eqz v1, :cond_1

    iget-object v1, v0, Lnet/time4j/tz/model/j;->s:Ljava/util/concurrent/ConcurrentMap;
...
.method private r(Lnet/time4j/e1/a;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lnet/time4j/tz/model/d;->i(Lnet/time4j/e1/a;)I
...
.method static s(Lnet/time4j/tz/q;Ljava/util/List;JJ)Ljava/util/List;
    ...
    invoke-virtual/range {p0 .. p0}, Lnet/time4j/tz/q;->h()J
...
.method private static u(Lnet/time4j/tz/model/d;J)I
    ...
    invoke-static {p1, p2, v1}, Lnet/time4j/e1/c;->b(JI)J

    move-result-wide p1

    sget-object v1, Lnet/time4j/f1/a0;->p:Lnet/time4j/f1/a0;
...
# virtual methods
.method public a(Lnet/time4j/e1/a;Lnet/time4j/e1/g;)Lnet/time4j/tz/q;
    .locals 2

    invoke-static {p1, p2}, Lnet/time4j/tz/model/l;->j(Lnet/time4j/e1/a;Lnet/time4j/e1/g;)J

    move-result-wide v0

    invoke-virtual {p0, p1, v0, v1}, Lnet/time4j/tz/model/j;->k(Lnet/time4j/e1/a;J)Lnet/time4j/tz/q;
...
.method public b()Lnet/time4j/tz/p;
    ...
    iget-object v0, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    invoke-virtual {v0}, Lnet/time4j/tz/q;->p()I
...
.method public c(Lnet/time4j/e1/a;Lnet/time4j/e1/g;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0, v1}, Lnet/time4j/tz/model/j;->t(Lnet/time4j/e1/a;J)Ljava/util/List;
...
.method public d(Lnet/time4j/e1/f;)Lnet/time4j/tz/q;
    .locals 14

    iget-object v0, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    invoke-virtual {v0}, Lnet/time4j/tz/q;->h()J

    move-result-wide v0

    invoke-interface {p1}, Lnet/time4j/e1/f;->z()J
    ...
    :cond_0
    iget-object v2, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    invoke-virtual {v2}, Lnet/time4j/tz/q;->o()I

    move-result v2

    iget-object v3, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;

    invoke-interface {v3}, Ljava/util/List;->size()I

    move-result v3

    iget-object v5, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    iget-object v7, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
    ...
    invoke-virtual {v7}, Lnet/time4j/tz/q;->h()J
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    iget-object v3, p1, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;
    ...
    iget-object v1, p0, Lnet/time4j/tz/model/j;->r:Ljava/util/List;

    iget-object p1, p1, Lnet/time4j/tz/model/j;->r:Ljava/util/List;
...
.method k(Lnet/time4j/e1/a;J)Lnet/time4j/tz/q;
    .locals 7
    ...
    iget-object v3, p0, Lnet/time4j/tz/model/j;->q:Lnet/time4j/tz/q;

    invoke-virtual {v3}, Lnet/time4j/tz/q;->p()I
    ...
    :cond_0
    invoke-direct {p0, p1}, Lnet/time4j/tz/model/j;->r(Lnet/time4j/e1/a;)Ljava/util/List;
    ...
    invoke-virtual {v0}, Lnet/time4j/tz/q;->q()Z
    ...
    :cond_3
    invoke-virtual {v0}, Lnet/time4j/tz/q;->r()Z
...
.method t(Lnet/time4j/e1/a;J)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2}, Lnet/time4j/tz/q;->p()I
