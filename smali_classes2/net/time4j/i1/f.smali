.class public final enum Lnet/time4j/i1/f;
...
# static fields
.field public static final enum o:Lnet/time4j/i1/f;

.field public static final enum p:Lnet/time4j/i1/f;

.field public static final enum q:Lnet/time4j/i1/f;

.field public static final enum r:Lnet/time4j/i1/f;

.field public static final enum s:Lnet/time4j/i1/f;

.field public static final enum t:Lnet/time4j/i1/f;

.field private static final synthetic u:[Lnet/time4j/i1/f;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/time4j/i1/f;

    const-string v1, "POSIX"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lnet/time4j/i1/f;->o:Lnet/time4j/i1/f;

    new-instance v1, Lnet/time4j/i1/f;

    const-string v3, "UTC"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lnet/time4j/i1/f;->p:Lnet/time4j/i1/f;

    new-instance v3, Lnet/time4j/i1/f;

    const-string v5, "TAI"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lnet/time4j/i1/f;->q:Lnet/time4j/i1/f;

    new-instance v5, Lnet/time4j/i1/f;

    const-string v7, "GPS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lnet/time4j/i1/f;->r:Lnet/time4j/i1/f;

    new-instance v7, Lnet/time4j/i1/f;

    const-string v9, "TT"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lnet/time4j/i1/f;->s:Lnet/time4j/i1/f;

    new-instance v9, Lnet/time4j/i1/f;

    const-string v11, "UT"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lnet/time4j/i1/f;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lnet/time4j/i1/f;->t:Lnet/time4j/i1/f;

    const/4 v11, 0x6

    new-array v11, v11, [Lnet/time4j/i1/f;
    ...
    sput-object v11, Lnet/time4j/i1/f;->u:[Lnet/time4j/i1/f;
...
.method public static d(II)D
    ...
    invoke-static {p0, v0, v1}, Lnet/time4j/i1/f;->b(ID)D
...
.method public static e(Lnet/time4j/e1/a;)D
    .locals 8
    ...
    invoke-static {v0, v6}, Lnet/time4j/e1/b;->d(II)I
    ...
    invoke-static {v0, v2, v3}, Lnet/time4j/i1/f;->b(ID)D
    ...
    invoke-interface {p0}, Lnet/time4j/e1/a;->toString()Ljava/lang/String;
...
.method public static valueOf(Ljava/lang/String;)Lnet/time4j/i1/f;
    .locals 1
    ...
    check-cast p0, Lnet/time4j/i1/f;

    return-object p0
.end method

.method public static values()[Lnet/time4j/i1/f;
    .locals 1

    sget-object v0, Lnet/time4j/i1/f;->u:[Lnet/time4j/i1/f;

    invoke-virtual {v0}, [Lnet/time4j/i1/f;->clone()Ljava/lang/Object;
