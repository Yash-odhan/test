...
.method private static e(Lnet/time4j/calendar/f;Lnet/time4j/calendar/f;I)J
    ...
    invoke-virtual {p0}, Lnet/time4j/calendar/f;->d()J
    ...
    :cond_2
    invoke-virtual {p0, p1}, Lnet/time4j/f1/m;->V(Lnet/time4j/f1/g;)Z
    ...
    :goto_0
    invoke-virtual {v3}, Lnet/time4j/calendar/f;->d0()I

    move-result p0

    invoke-virtual {v3}, Lnet/time4j/calendar/f;->p0()Lnet/time4j/calendar/c;
    ...
    invoke-virtual {v3}, Lnet/time4j/calendar/f;->k0()Lnet/time4j/calendar/h;

    move-result-object v5

    invoke-virtual {v5}, Lnet/time4j/calendar/h;->c()I

    move-result v6

    invoke-virtual {v5}, Lnet/time4j/calendar/h;->e()Z
    ...
    :goto_1
    invoke-virtual {v4}, Lnet/time4j/calendar/f;->d0()I

    move-result v11

    if-ne p0, v11, :cond_7

    invoke-virtual {v4}, Lnet/time4j/calendar/f;->p0()Lnet/time4j/calendar/c;

    move-result-object v11

    invoke-virtual {v11}, Lnet/time4j/calendar/o;->c()I

    move-result v11

    if-ne p1, v11, :cond_7

    invoke-virtual {v4}, Lnet/time4j/calendar/f;->k0()Lnet/time4j/calendar/h;
    ...
    invoke-virtual {v3}, Lnet/time4j/calendar/f;->s()I

    move-result p0

    invoke-virtual {v4}, Lnet/time4j/calendar/f;->s()I
    ...
    :cond_d
    :goto_4
    invoke-static {v6}, Lnet/time4j/calendar/h;->f(I)Lnet/time4j/calendar/h;

    move-result-object v5

    if-eqz v7, :cond_e

    invoke-virtual {v5}, Lnet/time4j/calendar/h;->h()Lnet/time4j/calendar/h;
    ...
    invoke-virtual {v0}, Lnet/time4j/calendar/o;->c()I

    move-result v0

    add-int/2addr p2, v0

    invoke-virtual {p0}, Lnet/time4j/calendar/f;->d0()I
    ...
    invoke-virtual {p0}, Lnet/time4j/calendar/f;->k0()Lnet/time4j/calendar/h;

    move-result-object v0

    invoke-virtual {p1}, Lnet/time4j/calendar/f;->k0()Lnet/time4j/calendar/h;
    ...
    invoke-virtual {p0}, Lnet/time4j/calendar/f;->s()I

    move-result p0

    invoke-virtual {p1}, Lnet/time4j/calendar/f;->s()I
...
.method private static g(IILnet/time4j/calendar/h;ILnet/time4j/calendar/d;)Lnet/time4j/calendar/f;
    ...
    invoke-virtual {v2}, Lnet/time4j/calendar/f;->s0()I
...
.method public c(Lnet/time4j/calendar/f;J)Lnet/time4j/calendar/f;
    ...
    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->c0()Lnet/time4j/calendar/d;

    move-result-object v2

    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->s()I

    move-result v3

    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->d0()I

    move-result v4

    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->p0()Lnet/time4j/calendar/c;

    move-result-object v5

    invoke-virtual {v5}, Lnet/time4j/calendar/o;->c()I

    move-result v5

    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->k0()Lnet/time4j/calendar/h;
    ...
    invoke-static {v0, v1, v3, v4}, Lnet/time4j/e1/c;->i(JJ)J

    move-result-wide v0

    :goto_0
    invoke-virtual/range {p1 .. p1}, Lnet/time4j/calendar/f;->d()J

    move-result-wide v3

    invoke-static {v3, v4, v0, v1}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    :goto_1
    invoke-virtual {v6}, Lnet/time4j/calendar/h;->c()I

    move-result v14

    invoke-virtual {v6}, Lnet/time4j/calendar/h;->e()Z
    ...
    invoke-static {v0, v1, v11, v12}, Lnet/time4j/e1/c;->i(JJ)J
    ...
    invoke-static {v4, v5, v0, v1}, Lnet/time4j/e1/c;->f(JJ)J

    move-result-wide v0

    invoke-static {v0, v1, v9}, Lnet/time4j/e1/c;->b(JI)J

    move-result-wide v4

    invoke-static {v4, v5}, Lnet/time4j/e1/c;->g(J)I

    move-result v4

    invoke-static {v0, v1, v9}, Lnet/time4j/e1/c;->d(JI)I
    ...
    invoke-static {v1}, Lnet/time4j/calendar/h;->f(I)Lnet/time4j/calendar/h;
