.class public final Ld/b/a/b/f/m/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/e;Lcom/google/android/gms/common/api/f$a;Lcom/google/android/gms/common/api/f$b;)V
    ...
    iput-object p1, p0, Ld/b/a/b/f/m/m;->I:Landroid/content/Context;
...
.method protected final m0(Ljava/lang/String;)Ljava/lang/String;
    .locals 4

    const/4 v0, 0x0

    :try_start_0
    iget-object v1, p0, Ld/b/a/b/f/m/m;->I:Landroid/content/Context;
    ...
    :cond_0
    iget-object v2, p0, Ld/b/a/b/f/m/m;->I:Landroid/content/Context;
...
.method protected final synthetic t(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Ld/b/a/b/f/m/h;

    if-eqz v1, :cond_1

    check-cast v0, Ld/b/a/b/f/m/h;

    return-object v0

    :cond_1
    new-instance v0, Ld/b/a/b/f/m/i;

    invoke-direct {v0, p1}, Ld/b/a/b/f/m/i;-><init>(Landroid/os/IBinder;)V
