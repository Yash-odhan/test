...
.field private final i:Lcom/google/firebase/messaging/c1;
...
.method private constructor <init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/firebase/messaging/k0;Lcom/google/firebase/messaging/c1;Lcom/google/firebase/messaging/f0;Landroid/content/Context;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/e1;->f:Ljava/util/Map;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/firebase/messaging/e1;->h:Z

    iput-object p1, p0, Lcom/google/firebase/messaging/e1;->e:Lcom/google/firebase/messaging/FirebaseMessaging;

    iput-object p2, p0, Lcom/google/firebase/messaging/e1;->c:Lcom/google/firebase/messaging/k0;

    iput-object p3, p0, Lcom/google/firebase/messaging/e1;->i:Lcom/google/firebase/messaging/c1;

    iput-object p4, p0, Lcom/google/firebase/messaging/e1;->d:Lcom/google/firebase/messaging/f0;

    iput-object p5, p0, Lcom/google/firebase/messaging/e1;->b:Landroid/content/Context;

    iput-object p6, p0, Lcom/google/firebase/messaging/e1;->g:Ljava/util/concurrent/ScheduledExecutorService;

    return-void
.end method

.method private a(Lcom/google/firebase/messaging/b1;Ld/b/a/b/k/m;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/e1;->f:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/e1;->f:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/e1;->f:Ljava/util/Map;
...
.method private static b(Ld/b/a/b/k/l;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v0, v1, v2}, Ld/b/a/b/k/o;->b(Ld/b/a/b/k/l;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_0
...
.method private c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/e1;->d:Lcom/google/firebase/messaging/f0;

    iget-object v1, p0, Lcom/google/firebase/messaging/e1;->e:Lcom/google/firebase/messaging/FirebaseMessaging;

    invoke-virtual {v1}, Lcom/google/firebase/messaging/FirebaseMessaging;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/messaging/f0;->k(Ljava/lang/String;Ljava/lang/String;)Ld/b/a/b/k/l;

    move-result-object p1

    invoke-static {p1}, Lcom/google/firebase/messaging/e1;->b(Ld/b/a/b/k/l;)V
...
.method private d(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/messaging/f0;->l(Ljava/lang/String;Ljava/lang/String;)Ld/b/a/b/k/l;
...
.method static e(Lcom/google/firebase/messaging/FirebaseMessaging;Lcom/google/firebase/messaging/k0;Lcom/google/firebase/messaging/f0;Landroid/content/Context;Ljava/util/concurrent/ScheduledExecutorService;)Ld/b/a/b/k/l;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p4, v6}, Ld/b/a/b/k/o;->d(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)Ld/b/a/b/k/l;
...
.method private j(Lcom/google/firebase/messaging/b1;)V
    ...
    invoke-virtual {v2, v3}, Ld/b/a/b/k/m;->c(Ljava/lang/Object;)V
...
.method f()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/e1;->i:Lcom/google/firebase/messaging/c1;
...
.method declared-synchronized h()Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/google/firebase/messaging/e1;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method l(Ljava/lang/Runnable;J)V
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/e1;->g:Ljava/util/concurrent/ScheduledExecutorService;
...
.method m(Lcom/google/firebase/messaging/b1;)Ld/b/a/b/k/l;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/firebase/messaging/e1;->a(Lcom/google/firebase/messaging/b1;Ld/b/a/b/k/m;)V
...
.method declared-synchronized n(Z)V
    ...
    :try_start_0
    iput-boolean p1, p0, Lcom/google/firebase/messaging/e1;->h:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method q(Ljava/lang/String;)Ld/b/a/b/k/l;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/e1;->m(Lcom/google/firebase/messaging/b1;)Ld/b/a/b/k/l;
...
.method r()Z
    ...
    :cond_2
    iget-object v1, p0, Lcom/google/firebase/messaging/e1;->i:Lcom/google/firebase/messaging/c1;
...
.method s(J)V
    ...
    iget-object v6, p0, Lcom/google/firebase/messaging/e1;->b:Landroid/content/Context;

    iget-object v7, p0, Lcom/google/firebase/messaging/e1;->c:Lcom/google/firebase/messaging/k0;
...
.method t(Ljava/lang/String;)Ld/b/a/b/k/l;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
