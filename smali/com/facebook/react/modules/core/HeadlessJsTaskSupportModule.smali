...
.method public notifyTaskFinished(D)V
    ...
    invoke-static {p2}, Lcom/facebook/react/a0/b;->e(Lcom/facebook/react/bridge/ReactContext;)Lcom/facebook/react/a0/b;

    move-result-object p2

    invoke-virtual {p2, p1}, Lcom/facebook/react/a0/b;->g(I)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p2, p1}, Lcom/facebook/react/a0/b;->d(I)V
    ...
    invoke-static {p2, p1, v0}, Ld/a/d/e/a;->D(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyTaskRetry(DLcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {p2, p1}, Lcom/facebook/react/a0/b;->j(I)Z
