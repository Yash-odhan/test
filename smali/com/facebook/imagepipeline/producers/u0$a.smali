...
.field private final d:Ld/a/k/q/d;
...
# direct methods
.method constructor <init>(Lcom/facebook/imagepipeline/producers/u0;Lcom/facebook/imagepipeline/producers/l;Lcom/facebook/imagepipeline/producers/p0;ZLd/a/k/q/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Ld/a/k/o/b;->n()Ljava/lang/Boolean;
    ...
    iput-object p5, p0, Lcom/facebook/imagepipeline/producers/u0$a;->d:Ld/a/k/q/d;
    ...
    invoke-interface {p3, p4}, Lcom/facebook/imagepipeline/producers/p0;->r(Lcom/facebook/imagepipeline/producers/q0;)V

    return-void
.end method

.method private A(Ld/a/k/k/d;)Ld/a/k/k/d;
    .locals 2
    ...
    invoke-virtual {v0}, Ld/a/k/e/f;->g()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {v0}, Ld/a/k/e/f;->f()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Ld/a/k/e/f;->e()I

    move-result v0

    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/producers/u0$a;->y(Ld/a/k/k/d;I)Ld/a/k/k/d;
...
.method private B(Ld/a/k/k/d;)Ld/a/k/k/d;
    .locals 2
    ...
    invoke-virtual {v0}, Ld/a/k/e/f;->c()Z
...
.method static synthetic r(Lcom/facebook/imagepipeline/producers/u0$a;)Ld/a/k/q/d;
    .locals 0

    iget-object p0, p0, Lcom/facebook/imagepipeline/producers/u0$a;->d:Ld/a/k/q/d;

    return-object p0
.end method

.method static synthetic s(Lcom/facebook/imagepipeline/producers/u0$a;Ld/a/k/k/d;ILd/a/k/q/c;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/facebook/imagepipeline/producers/u0$a;->w(Ld/a/k/k/d;ILd/a/k/q/c;)V
...
.method private w(Ld/a/k/k/d;ILd/a/k/q/c;)V
    .locals 11
    ...
    invoke-static {v1}, Lcom/facebook/imagepipeline/producers/u0;->e(Lcom/facebook/imagepipeline/producers/u0;)Ld/a/d/g/h;

    move-result-object v1

    invoke-interface {v1}, Ld/a/d/g/h;->a()Ld/a/d/g/j;
    ...
    invoke-interface/range {v3 .. v9}, Ld/a/k/q/c;->c(Ld/a/k/k/d;Ljava/io/OutputStream;Ld/a/k/e/f;Ld/a/k/e/e;Ld/a/j/c;Ljava/lang/Integer;)Ld/a/k/q/b;

    move-result-object v3

    invoke-virtual {v3}, Ld/a/k/q/b;->a()I
    ...
    invoke-interface {p3}, Ld/a/k/q/c;->a()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p0, p1, v0, v3, p3}, Lcom/facebook/imagepipeline/producers/u0$a;->z(Ld/a/k/k/d;Ld/a/k/e/e;Ld/a/k/q/b;Ljava/lang/String;)Ljava/util/Map;

    move-result-object v10

    invoke-virtual {v1}, Ld/a/d/g/j;->a()Ld/a/d/g/g;
    ...
    :try_start_1
    new-instance p3, Ld/a/k/k/d;

    invoke-direct {p3, p1}, Ld/a/k/k/d;-><init>(Ld/a/d/h/a;)V

    sget-object v0, Ld/a/j/b;->a:Ld/a/j/c;

    invoke-virtual {p3, v0}, Ld/a/k/k/d;->r0(Ld/a/j/c;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    invoke-virtual {p3}, Ld/a/k/k/d;->X()V
    ...
    :try_start_3
    invoke-static {p3}, Ld/a/k/k/d;->c(Ld/a/k/k/d;)V
    :try_end_3
    ...
    invoke-virtual {v1}, Ld/a/d/g/j;->close()V
...
.method private x(Ld/a/k/k/d;ILd/a/j/c;)V
    .locals 1
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/producers/u0$a;->A(Ld/a/k/k/d;)Ld/a/k/k/d;
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/producers/u0$a;->B(Ld/a/k/k/d;)Ld/a/k/k/d;
...
.method private y(Ld/a/k/k/d;I)Ld/a/k/k/d;
    .locals 0
    ...
    invoke-virtual {p1, p2}, Ld/a/k/k/d;->t0(I)V

    :cond_0
    return-object p1
.end method

.method private z(Ld/a/k/k/d;Ld/a/k/e/e;Ld/a/k/q/b;Ljava/lang/String;)Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget v3, p2, Ld/a/k/e/e;->a:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget p2, p2, Ld/a/k/e/e;->b:I
    ...
    invoke-static {v1}, Ld/a/d/d/g;->a(Ljava/util/Map;)Ld/a/d/d/g;
...
# virtual methods
.method protected C(Ld/a/k/k/d;I)V
    .locals 5
    ...
    invoke-interface {v2}, Lcom/facebook/imagepipeline/producers/p0;->q()Ld/a/k/o/b;

    move-result-object v2

    iget-object v3, p0, Lcom/facebook/imagepipeline/producers/u0$a;->d:Ld/a/k/q/d;

    iget-boolean v4, p0, Lcom/facebook/imagepipeline/producers/u0$a;->c:Z

    invoke-interface {v3, v1, v4}, Ld/a/k/q/d;->createImageTranscoder(Ld/a/j/c;Z)Ld/a/k/q/c;

    move-result-object v3

    invoke-static {v3}, Ld/a/d/d/k;->g(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ld/a/k/q/c;

    invoke-static {v2, p1, v3}, Lcom/facebook/imagepipeline/producers/u0;->d(Ld/a/k/o/b;Ld/a/k/k/d;Ld/a/k/q/c;)Ld/a/d/k/e;

    move-result-object v2

    if-nez v0, :cond_3

    sget-object v3, Ld/a/d/k/e;->q:Ld/a/d/k/e;
    ...
    :cond_3
    sget-object v3, Ld/a/d/k/e;->o:Ld/a/d/k/e;

    if-eq v2, v3, :cond_4

    invoke-direct {p0, p1, p2, v1}, Lcom/facebook/imagepipeline/producers/u0$a;->x(Ld/a/k/k/d;ILd/a/j/c;)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/facebook/imagepipeline/producers/a0;->k(Ld/a/k/k/d;I)Z
...
.method protected bridge synthetic i(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/facebook/imagepipeline/producers/u0$a;->C(Ld/a/k/k/d;I)V
