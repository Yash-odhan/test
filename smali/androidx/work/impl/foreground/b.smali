...
.field private final r:Landroidx/work/impl/utils/p/a;
...
.field final x:Landroidx/work/impl/m/d;

.field private y:Landroidx/work/impl/foreground/b$b;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/foreground/b;->p:Landroid/content/Context;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/foreground/b;->s:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/work/impl/foreground/b;->p:Landroid/content/Context;
    ...
    invoke-virtual {p1}, Landroidx/work/impl/j;->w()Landroidx/work/impl/utils/p/a;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/foreground/b;->r:Landroidx/work/impl/utils/p/a;

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->t:Ljava/lang/String;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->u:Ljava/util/Map;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->w:Ljava/util/Set;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroidx/work/impl/foreground/b;->v:Ljava/util/Map;

    new-instance v0, Landroidx/work/impl/m/d;

    iget-object v1, p0, Landroidx/work/impl/foreground/b;->p:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroidx/work/impl/foreground/b;->x:Landroidx/work/impl/m/d;
    ...
    invoke-virtual {p1, p0}, Landroidx/work/impl/d;->b(Landroidx/work/impl/b;)V
...
.method private c(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/work/impl/j;->k(Ljava/util/UUID;)Landroidx/work/p;
...
.method private e(Landroid/content/Intent;)V
    ...
    sget-object v5, Landroidx/work/impl/foreground/b;->o:Ljava/lang/String;
    ...
    iget-object v4, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
    ...
    iget-object v5, p0, Landroidx/work/impl/foreground/b;->u:Ljava/util/Map;

    invoke-interface {v5, v3, v4}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v4, p0, Landroidx/work/impl/foreground/b;->t:Ljava/lang/String;
    ...
    iput-object v3, p0, Landroidx/work/impl/foreground/b;->t:Ljava/lang/String;

    iget-object v1, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
    ...
    :cond_0
    iget-object v3, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
    ...
    iget-object p1, p0, Landroidx/work/impl/foreground/b;->u:Ljava/util/Map;
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->t:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
...
.method private g(Landroid/content/Intent;)V
    ...
    iget-object v1, p0, Landroidx/work/impl/foreground/b;->r:Landroidx/work/impl/utils/p/a;
...
.method public d(Ljava/lang/String;Z)V
    ...
    iget-object p2, p0, Landroidx/work/impl/foreground/b;->s:Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/work/impl/foreground/b;->w:Ljava/util/Set;
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->x:Landroidx/work/impl/m/d;
    ...
    iget-object p2, p0, Landroidx/work/impl/foreground/b;->u:Ljava/util/Map;
    ...
    iget-object v0, p0, Landroidx/work/impl/foreground/b;->u:Ljava/util/Map;
    ...
    iget-object v2, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
    ...
    invoke-interface {v2, v0}, Landroidx/work/impl/foreground/b$b;->f(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/work/impl/foreground/b$b;->f(I)V
...
.method h(Landroid/content/Intent;)V
    ...
    iget-object p1, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
...
.method i()V
    ...
    iput-object v0, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;

    iget-object v0, p0, Landroidx/work/impl/foreground/b;->s:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Landroidx/work/impl/foreground/b;->x:Landroidx/work/impl/m/d;
    ...
    invoke-virtual {v0, p0}, Landroidx/work/impl/d;->h(Landroidx/work/impl/b;)V
...
.method k(Landroidx/work/impl/foreground/b$b;)V
    .locals 3
    ...
    :cond_0
    iput-object p1, p0, Landroidx/work/impl/foreground/b;->y:Landroidx/work/impl/foreground/b$b;
