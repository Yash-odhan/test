...
.method public static b(Landroidx/work/b;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    invoke-interface {v0, p0}, Landroidx/work/impl/n/q;->g(I)Ljava/util/List;

    move-result-object p0

    const/16 v1, 0xc8

    invoke-interface {v0, v1}, Landroidx/work/impl/n/q;->u(I)Ljava/util/List;
    ...
    invoke-interface {v0, v5, v2, v3}, Landroidx/work/impl/n/q;->d(Ljava/lang/String;J)I
    ...
    invoke-interface {v0}, Landroidx/work/impl/e;->c()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {v0, p0}, Landroidx/work/impl/e;->a([Landroidx/work/impl/n/p;)V
    ...
    invoke-interface {p2}, Landroidx/work/impl/e;->c()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-interface {p2, p0}, Landroidx/work/impl/e;->a([Landroidx/work/impl/n/p;)V
