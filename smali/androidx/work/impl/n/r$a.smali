...
.method public bridge synthetic g(La/s/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/n/r$a;->i(La/s/a/f;Landroidx/work/impl/n/p;)V

    return-void
.end method

.method public i(La/s/a/f;Landroidx/work/impl/n/p;)V
    .locals 10
    ...
    :goto_0
    iget-object v0, p2, Landroidx/work/impl/n/p;->d:Landroidx/work/v;

    invoke-static {v0}, Landroidx/work/impl/n/v;->h(Landroidx/work/v;)I
    ...
    invoke-interface {p1, v1, v2, v3}, La/s/a/d;->u0(IJ)V
    ...
    invoke-static {v8}, Landroidx/work/impl/n/v;->g(Landroidx/work/n;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, La/s/a/d;->u0(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, La/s/a/d;->u0(IJ)V
    ...
    invoke-interface {p1, v4, v5, v6}, La/s/a/d;->u0(IJ)V
    ...
    invoke-interface {p1, v3, v4, v5}, La/s/a/d;->u0(IJ)V
    ...
    invoke-interface {p1, v2, v3, v4}, La/s/a/d;->u0(IJ)V
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, La/s/a/d;->y0(I[B)V

    goto :goto_6

    :cond_6
    invoke-interface {p1, v6}, La/s/a/d;->b1(I)V

    invoke-interface {p1, v5}, La/s/a/d;->b1(I)V

    invoke-interface {p1, v4}, La/s/a/d;->b1(I)V

    invoke-interface {p1, v3}, La/s/a/d;->b1(I)V

    invoke-interface {p1, v2}, La/s/a/d;->b1(I)V
    ...
    :goto_5
    invoke-interface {p1, v7}, La/s/a/d;->b1(I)V
