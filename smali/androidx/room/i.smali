...
# instance fields
.field protected volatile a:La/s/a/b;
...
.method public c()V
    ...
    iget-object v0, p0, Landroidx/room/i;->d:La/s/a/c;
    ...
    invoke-virtual {v1, v0}, Landroidx/room/f;->m(La/s/a/b;)V

    invoke-interface {v0}, La/s/a/b;->k()V

    return-void
.end method

.method public d(Ljava/lang/String;)La/s/a/f;
    .locals 1
    ...
    invoke-interface {v0, p1}, La/s/a/b;->S(Ljava/lang/String;)La/s/a/f;
...
.method protected abstract f(Landroidx/room/a;)La/s/a/c;
.end method
...
.method public g()V
    ...
    invoke-interface {v0}, La/s/a/b;->y()V
...
.method public k()Z
    ...
    invoke-interface {v0}, La/s/a/b;->i1()Z
...
.method public l(Landroidx/room/a;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/room/i;->f(Landroidx/room/a;)La/s/a/c;

    move-result-object v0

    iput-object v0, p0, Landroidx/room/i;->d:La/s/a/c;
    ...
    invoke-interface {v0, v2}, La/s/a/c;->setWriteAheadLoggingEnabled(Z)V
...
.method protected m(La/s/a/b;)V
    .locals 1

    iget-object v0, p0, Landroidx/room/i;->e:Landroidx/room/f;

    invoke-virtual {v0, p1}, Landroidx/room/f;->d(La/s/a/b;)V
...
.method public o()Z
    ...
    iget-object v0, p0, Landroidx/room/i;->a:La/s/a/b;

    if-eqz v0, :cond_0

    invoke-interface {v0}, La/s/a/b;->isOpen()Z
...
.method public p(La/s/a/e;)Landroid/database/Cursor;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Landroidx/room/i;->q(La/s/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public q(La/s/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    .locals 2
    ...
    invoke-interface {v0, p1, p2}, La/s/a/b;->j0(La/s/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :cond_0
    iget-object p2, p0, Landroidx/room/i;->d:La/s/a/c;

    invoke-interface {p2}, La/s/a/c;->C0()La/s/a/b;

    move-result-object p2

    invoke-interface {p2, p1}, La/s/a/b;->a1(La/s/a/e;)Landroid/database/Cursor;
...
.method public r()V
    ...
    invoke-interface {v0}, La/s/a/b;->v()V
