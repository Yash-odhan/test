...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
    ...
    invoke-virtual {p2, v5, v3}, Landroidx/appcompat/widget/x0;->k(II)I
    ...
    invoke-virtual {p2, v5}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {p2, v6}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {p2, v5, v6, p1}, Landroidx/appcompat/widget/x0;->j(IILa/h/e/d/f$a;)Landroid/graphics/Typeface;
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    sget-object v4, La/a/j;->a0:[I

    const/4 v5, 0x0

    invoke-static {v2, v0, v4, v1, v5}, Landroidx/appcompat/widget/x0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/x0;
    ...
    invoke-virtual {v4, v6, v8}, Landroidx/appcompat/widget/x0;->n(II)I

    move-result v6

    sget v9, La/a/j;->e0:I

    invoke-virtual {v4, v9}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v10

    if-eqz v10, :cond_0

    invoke-virtual {v4, v9, v5}, Landroidx/appcompat/widget/x0;->n(II)I

    move-result v9

    invoke-static {v2, v3, v9}, Landroidx/appcompat/widget/y;->d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/v0;

    move-result-object v9

    iput-object v9, v7, Landroidx/appcompat/widget/y;->b:Landroidx/appcompat/widget/v0;
    ...
    iput-object v9, v7, Landroidx/appcompat/widget/y;->c:Landroidx/appcompat/widget/v0;
    ...
    iput-object v9, v7, Landroidx/appcompat/widget/y;->d:Landroidx/appcompat/widget/v0;
    ...
    iput-object v9, v7, Landroidx/appcompat/widget/y;->e:Landroidx/appcompat/widget/v0;
    ...
    sget v10, La/a/j;->g0:I

    invoke-virtual {v4, v10}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v11

    if-eqz v11, :cond_4

    invoke-virtual {v4, v10, v5}, Landroidx/appcompat/widget/x0;->n(II)I

    move-result v10

    invoke-static {v2, v3, v10}, Landroidx/appcompat/widget/y;->d(Landroid/content/Context;Landroidx/appcompat/widget/j;I)Landroidx/appcompat/widget/v0;

    move-result-object v10

    iput-object v10, v7, Landroidx/appcompat/widget/y;->f:Landroidx/appcompat/widget/v0;

    :cond_4
    sget v10, La/a/j;->h0:I
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/y;->g:Landroidx/appcompat/widget/v0;

    :cond_5
    invoke-virtual {v4}, Landroidx/appcompat/widget/x0;->v()V
    ...
    sget-object v14, La/a/j;->X2:[I

    invoke-static {v2, v6, v14}, Landroidx/appcompat/widget/x0;->s(Landroid/content/Context;I[I)Landroidx/appcompat/widget/x0;

    move-result-object v6

    if-nez v4, :cond_6

    sget v14, La/a/j;->i3:I

    invoke-virtual {v6, v14}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v15

    if-eqz v15, :cond_6

    invoke-virtual {v6, v14, v5}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v2, v6}, Landroidx/appcompat/widget/y;->C(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V

    if-ge v9, v12, :cond_a

    sget v11, La/a/j;->b3:I

    invoke-virtual {v6, v11}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v17

    if-eqz v17, :cond_7

    invoke-virtual {v6, v11}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    sget v13, La/a/j;->c3:I

    invoke-virtual {v6, v13}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v18

    if-eqz v18, :cond_8

    invoke-virtual {v6, v13}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v8}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v19

    if-eqz v19, :cond_9

    invoke-virtual {v6, v8}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_3
    sget v12, La/a/j;->j3:I

    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v20

    if-eqz v20, :cond_b

    invoke-virtual {v6, v12}, Landroidx/appcompat/widget/x0;->o(I)Ljava/lang/String;
    ...
    sget v10, La/a/j;->h3:I

    invoke-virtual {v6, v10}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v21

    if-eqz v21, :cond_c

    invoke-virtual {v6, v10}, Landroidx/appcompat/widget/x0;->o(I)Ljava/lang/String;
    ...
    :goto_5
    invoke-virtual {v6}, Landroidx/appcompat/widget/x0;->v()V
    ...
    :goto_6
    sget-object v6, La/a/j;->X2:[I

    invoke-static {v2, v0, v6, v1, v5}, Landroidx/appcompat/widget/x0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/x0;
    ...
    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {v6, v5, v8}, Landroidx/appcompat/widget/x0;->a(IZ)Z
    ...
    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/x0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v6, v5, v3}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    invoke-virtual {v7, v14}, Landroidx/appcompat/widget/y;->r(Z)V
    ...
    iget v3, v7, Landroidx/appcompat/widget/y;->k:I
    ...
    invoke-virtual {v0, v3, v1}, Landroidx/appcompat/widget/a0;->t(Landroid/util/AttributeSet;I)V
    ...
    :cond_20
    :goto_c
    sget-object v0, La/a/j;->i0:[I

    invoke-static {v2, v3, v0}, Landroidx/appcompat/widget/x0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/x0;
    ...
    invoke-virtual {v8, v0}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {v8}, Landroidx/appcompat/widget/x0;->v()V
...
.method p(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v0}, Landroidx/appcompat/widget/x0;->r(I)Z
    ...
    invoke-virtual {p2, v1}, Landroidx/appcompat/widget/x0;->r(I)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {p2, v1}, Landroidx/appcompat/widget/x0;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, v1, v3}, Landroidx/appcompat/widget/x0;->f(II)I
    ...
    :cond_2
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/y;->C(Landroid/content/Context;Landroidx/appcompat/widget/x0;)V
    ...
    :cond_3
    invoke-virtual {p2}, Landroidx/appcompat/widget/x0;->v()V
