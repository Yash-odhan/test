...
# instance fields
.field private final A:Landroidx/appcompat/widget/k0;
...
.field N:Landroid/view/ViewTreeObserver;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->A:Landroidx/appcompat/widget/k0;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->q:Landroid/content/Context;

    iput-object p2, p0, Landroidx/appcompat/view/menu/d;->D:Landroid/view/View;

    iput p3, p0, Landroidx/appcompat/view/menu/d;->s:I

    iput p4, p0, Landroidx/appcompat/view/menu/d;->t:I

    iput-boolean p5, p0, Landroidx/appcompat/view/menu/d;->u:Z
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->v:Landroid/os/Handler;
...
.method private A(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;
...
.method private D()I
    ...
    invoke-static {v0}, La/h/m/t;->w(Landroid/view/View;)I
...
.method private E(I)I
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/d;->E:Landroid/view/View;
...
.method private F(Landroidx/appcompat/view/menu/g;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->q:Landroid/content/Context;
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->q:Landroid/content/Context;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;
    ...
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/d;->F:I
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/d;->D:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/d;->C:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/d;->D:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/d;->C:I
    ...
    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/j0;->l(I)V
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/j0;->h()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/j0;->j()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/l0;
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->q:Landroid/content/Context;

    iget v2, p0, Landroidx/appcompat/view/menu/d;->s:I
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->A:Landroidx/appcompat/widget/k0;
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    :goto_0
    iput v1, p0, Landroidx/appcompat/view/menu/d;->F:I

    if-nez v0, :cond_7

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->dismiss()V

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->M:Landroidx/appcompat/view/menu/m$a;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/view/ViewTreeObserver;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {p1, p2}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->E:Landroid/view/View;

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {p1, p2}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->O:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->x:Ljava/util/List;
...
.method public g(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->M:Landroidx/appcompat/view/menu/m$a;
...
.method public h()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->E:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->N:Landroid/view/ViewTreeObserver;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->y:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_3
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->E:Landroid/view/View;

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->z:Landroid/view/View$OnAttachStateChangeListener;
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->M:Landroidx/appcompat/view/menu/m$a;
...
.method public p(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->D:Landroid/view/View;
...
.method public u(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->O:Landroid/widget/PopupWindow$OnDismissListener;
