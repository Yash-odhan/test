...
.method private static g(Ljava/lang/Class;Lnet/time4j/g;Lnet/time4j/g0;J)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lnet/time4j/g0;->n0(Lnet/time4j/g0;)B

    move-result v0

    invoke-static {p2}, Lnet/time4j/g0;->p0(Lnet/time4j/g0;)B

    move-result v1

    invoke-static {p2}, Lnet/time4j/g0;->S(Lnet/time4j/g0;)I
    ...
    invoke-static {v0, v1, p3, p4}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    invoke-static {v2, v3, v5, v6}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    invoke-static {v2, v3, v4}, Lnet/time4j/e1/c;->b(JI)J

    move-result-wide v7

    invoke-static {v5, v6, v7, v8}, Lnet/time4j/e1/c;->f(JJ)J

    move-result-wide v5

    invoke-static {p2}, Lnet/time4j/g0;->m0(Lnet/time4j/g0;)B

    move-result p2

    int-to-long v7, p2

    invoke-static {v5, v6, v4}, Lnet/time4j/e1/c;->b(JI)J

    move-result-wide v9

    invoke-static {v7, v8, v9, v10}, Lnet/time4j/e1/c;->f(JJ)J

    move-result-wide v7

    invoke-static {v5, v6, v4}, Lnet/time4j/e1/c;->d(JI)I

    move-result p2

    invoke-static {v2, v3, v4}, Lnet/time4j/e1/c;->d(JI)I
    ...
    :pswitch_1
    sget-object p1, Lnet/time4j/g;->t:Lnet/time4j/g;

    const-wide/16 v0, 0x3e8

    invoke-static {p3, p4, v0, v1}, Lnet/time4j/e1/c;->i(JJ)J
    ...
    invoke-static {v0, v1, v4}, Lnet/time4j/e1/c;->b(JI)J
    ...
    invoke-static {p1, p2, v7, v8}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    invoke-static {v0, v1, v4}, Lnet/time4j/e1/c;->d(JI)I
    ...
    invoke-static {v5, v6, p3, p4}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    invoke-static {p1, p2, p3, p4}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    invoke-static {v7, v8, p1}, Lnet/time4j/e1/c;->d(JI)I
    ...
    :cond_1
    invoke-static {p2, v0, v1, v2}, Lnet/time4j/g0;->V0(IIII)Lnet/time4j/g0;
    ...
    :cond_2
    invoke-static {v7, v8, p1}, Lnet/time4j/e1/c;->b(JI)J
...
.method public f(Lnet/time4j/g0;Lnet/time4j/g0;)J
    ...
    invoke-static {p2}, Lnet/time4j/g0;->l0(Lnet/time4j/g0;)J
