...
.method public bridge synthetic c(Lnet/time4j/f1/q;Lnet/time4j/f1/d;ZZ)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lnet/time4j/h0$e;->d(Lnet/time4j/f1/q;Lnet/time4j/f1/d;ZZ)Lnet/time4j/h0;
...
.method public d(Lnet/time4j/f1/q;Lnet/time4j/f1/d;ZZ)Lnet/time4j/h0;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p4, Lnet/time4j/g1/a;->c:Lnet/time4j/f1/c;

    invoke-interface {p2, p4}, Lnet/time4j/f1/d;->c(Lnet/time4j/f1/c;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-interface {p2, p4}, Lnet/time4j/f1/d;->b(Lnet/time4j/f1/c;)Ljava/lang/Object;
    ...
    sget-object p2, Lnet/time4j/tz/p;->v:Lnet/time4j/tz/p;

    :goto_0
    const-class p3, Lnet/time4j/e1/f;
    ...
    invoke-virtual {p1, p2}, Lnet/time4j/a0;->D0(Lnet/time4j/tz/k;)Lnet/time4j/h0;
    ...
    invoke-virtual {p1, p4}, Lnet/time4j/f1/q;->e(Lnet/time4j/f1/p;)I
    ...
    invoke-virtual {v1, p1, p2, p3, v0}, Lnet/time4j/f1/h0;->M(Lnet/time4j/f1/q;Lnet/time4j/f1/d;ZZ)Lnet/time4j/f1/k0;
    ...
    invoke-virtual {v3, p1, p2, p3, v0}, Lnet/time4j/f1/h0;->M(Lnet/time4j/f1/q;Lnet/time4j/f1/d;ZZ)Lnet/time4j/f1/k0;
    ...
    :cond_9
    sget-object p3, Lnet/time4j/x;->r:Lnet/time4j/f1/p;
    ...
    invoke-virtual {v1, v2, v3, p3}, Lnet/time4j/f1/k0;->Q(JLjava/lang/Object;)Lnet/time4j/f1/k0;
    ...
    sget-object p3, Lnet/time4j/f1/b0;->o:Lnet/time4j/f1/b0;

    sget-object p4, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    invoke-virtual {p1, p3, p4}, Lnet/time4j/f1/q;->H(Lnet/time4j/f1/p;Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-virtual {p1, p3, p4}, Lnet/time4j/f1/q;->K(Lnet/time4j/f1/p;Ljava/lang/Object;)Lnet/time4j/f1/q;

    :cond_b
    invoke-static {v1, p2}, Lnet/time4j/h0;->j0(Lnet/time4j/f0;Lnet/time4j/g0;)Lnet/time4j/h0;
...
.method public e(Lnet/time4j/h0;Lnet/time4j/f1/d;)Lnet/time4j/f1/o;
    .locals 0
...
.method public bridge synthetic g(Ljava/lang/Object;Lnet/time4j/f1/d;)Lnet/time4j/f1/o;
    ...
    invoke-virtual {p0, p1, p2}, Lnet/time4j/h0$e;->e(Lnet/time4j/h0;Lnet/time4j/f1/d;)Lnet/time4j/f1/o;
...
.method public i(Lnet/time4j/f1/y;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p1, p1, p2}, Lnet/time4j/g1/b;->u(Lnet/time4j/g1/e;Lnet/time4j/g1/e;Ljava/util/Locale;)Ljava/lang/String;
