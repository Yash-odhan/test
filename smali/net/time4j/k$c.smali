...
.method private static e(Ljava/util/Locale;Lnet/time4j/f1/d;)Lnet/time4j/k;
    .locals 2

    invoke-static {}, Lnet/time4j/k;->b()Lnet/time4j/f1/c;
    ...
    invoke-interface {p1, p0}, Lnet/time4j/f1/d;->b(Lnet/time4j/f1/c;)Ljava/lang/Object;
...
.method private static f(Lnet/time4j/f1/q;)I
    .locals 2
...
.method public b(Lnet/time4j/f1/q;Ljava/util/Locale;Lnet/time4j/f1/d;)Lnet/time4j/f1/q;
    ...
    invoke-virtual {v0, v1}, Lnet/time4j/f1/q;->x(Lnet/time4j/f1/p;)Z
    ...
    :cond_0
    invoke-static/range {p2 .. p3}, Lnet/time4j/k$c;->e(Ljava/util/Locale;Lnet/time4j/f1/d;)Lnet/time4j/k;
    ...
    invoke-virtual {v0, v2}, Lnet/time4j/f1/q;->x(Lnet/time4j/f1/p;)Z
    ...
    sget-object v3, Lnet/time4j/z;->o:Lnet/time4j/z;
    ...
    sget-object v3, Lnet/time4j/z;->p:Lnet/time4j/z;
    ...
    invoke-static/range {p1 .. p1}, Lnet/time4j/k$c;->f(Lnet/time4j/f1/q;)I
    ...
    invoke-virtual {v13}, Lnet/time4j/g0;->u()I
    ...
    invoke-virtual {v15, v13}, Lnet/time4j/g0;->H0(Lnet/time4j/g0;)Z
    ...
    invoke-virtual {v15, v6}, Lnet/time4j/g0;->N0(Lnet/time4j/g0;)Z
    ...
    :cond_5
    :goto_4
    sget-object v6, Lnet/time4j/z;->p:Lnet/time4j/z;

    goto :goto_6

    :cond_6
    invoke-static {v6}, Lnet/time4j/g0;->S0(I)Lnet/time4j/g0;

    move-result-object v6

    invoke-virtual {v15, v6}, Lnet/time4j/g0;->H0(Lnet/time4j/g0;)Z
    ...
    :cond_7
    :goto_5
    sget-object v6, Lnet/time4j/z;->o:Lnet/time4j/z;
    ...
    invoke-virtual {v0, v1, v9}, Lnet/time4j/f1/q;->K(Lnet/time4j/f1/p;Ljava/lang/Object;)Lnet/time4j/f1/q;
    ...
    :goto_d
    invoke-virtual {v0, v1, v3}, Lnet/time4j/f1/q;->K(Lnet/time4j/f1/p;Ljava/lang/Object;)Lnet/time4j/f1/q;
    ...
    :goto_e
    invoke-virtual {v0, v2, v1}, Lnet/time4j/f1/q;->K(Lnet/time4j/f1/p;Ljava/lang/Object;)Lnet/time4j/f1/q;
...
.method public c(Ljava/util/Locale;Lnet/time4j/f1/d;)Ljava/util/Set;
    ...
    invoke-static {p1, p2}, Lnet/time4j/k$c;->e(Ljava/util/Locale;Lnet/time4j/f1/d;)Lnet/time4j/k;
    ...
    invoke-interface {p2, v1}, Lnet/time4j/f1/d;->c(Lnet/time4j/f1/c;)Z
