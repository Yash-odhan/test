...
.method constructor <init>(Ljava/lang/Object;I)V
    ...
    iput-object p1, p0, Lnet/time4j/SPX;->o:Ljava/lang/Object;

    iput p2, p0, Lnet/time4j/SPX;->p:I
...
.method private a(Ljava/io/DataInput;B)Lnet/time4j/f0;
    ...
    :goto_0
    invoke-static {p2}, Lnet/time4j/b0;->k(I)Lnet/time4j/b0;

    move-result-object p2

    invoke-static {p1, p2, v0}, Lnet/time4j/f0;->Z0(ILnet/time4j/b0;I)Lnet/time4j/f0;
...
.method private c(Ljava/io/ObjectInput;B)Ljava/lang/Object;
    ...
    invoke-static {v3, v4, v5}, Lnet/time4j/f1/l0$a;->c(JLjava/lang/Object;)Lnet/time4j/f1/l0$a;
...
.method private d(Ljava/io/ObjectInput;B)Ljava/lang/Object;
    ...
    :goto_1
    sget-object p2, Lnet/time4j/i1/f;->p:Lnet/time4j/i1/f;

    if-ne v0, p2, :cond_2

    invoke-static {v1, v2, p1}, Lnet/time4j/y;->p(JI)Lnet/time4j/y;
    ...
    :cond_2
    invoke-static {v1, v2, p1}, Lnet/time4j/y;->o(JI)Lnet/time4j/y;
...
.method private e(Ljava/io/DataInput;B)Ljava/lang/Object;
    ...
    :goto_1
    invoke-static {p1, v0, v1}, Lnet/time4j/a0;->y0(Ljava/io/DataInput;ZZ)Lnet/time4j/a0;
...
.method private f(Ljava/io/DataInput;)Lnet/time4j/g0;
    ...
    invoke-static {p1}, Lnet/time4j/g0;->S0(I)Lnet/time4j/g0;
    ...
    :goto_1
    invoke-static {v0, v1, v2, p1}, Lnet/time4j/g0;->V0(IIII)Lnet/time4j/g0;
...
.method private h(Ljava/io/DataInput;B)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lnet/time4j/x0;->o(I)Lnet/time4j/x0;
...
.method private i(Ljava/io/DataOutput;)V
    ...
    iget-object v0, p0, Lnet/time4j/SPX;->o:Ljava/lang/Object;
...
.method private static j(Lnet/time4j/f0;ILjava/io/DataOutput;)V
    ...
    invoke-virtual {p0}, Lnet/time4j/f0;->q()I
    ...
    invoke-virtual {p0}, Lnet/time4j/f0;->s()I
...
.method private k(Ljava/io/ObjectOutput;)V
    ...
    iget-object v1, p0, Lnet/time4j/SPX;->o:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lnet/time4j/k$b;->M()Ljava/util/Locale;

    move-result-object v1

    invoke-virtual {v0}, Lnet/time4j/k$b;->Q()Z
    ...
    invoke-virtual {v0}, Lnet/time4j/k$b;->J()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lnet/time4j/k$b;->E()Ljava/lang/String;
...
.method private l(Ljava/io/ObjectOutput;)V
    ...
    check-cast v5, Lnet/time4j/f1/l0$a;

    invoke-virtual {v5}, Lnet/time4j/f1/l0$a;->a()J
...
.method private m(Ljava/io/ObjectOutput;)V
    ...
    invoke-virtual {v0}, Lnet/time4j/y;->h()Lnet/time4j/i1/f;
    ...
    :goto_0
    invoke-virtual {v0}, Lnet/time4j/y;->f()I
    ...
    invoke-virtual {v0}, Lnet/time4j/y;->k()J
...
.method private n(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v0, p1}, Lnet/time4j/a0;->G0(Ljava/io/DataOutput;)V
...
.method private static p(Lnet/time4j/g0;Ljava/io/DataOutput;)V
    ...
    invoke-virtual {p0}, Lnet/time4j/g0;->w()I

    move-result v0

    if-nez v0, :cond_1

    invoke-virtual {p0}, Lnet/time4j/g0;->h()I

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lnet/time4j/g0;->u()I
...
.method private r(Ljava/io/DataOutput;)V
    ...
    sget-object v2, Lnet/time4j/x0;->u:Lnet/time4j/x0;
...
.method public writeExternal(Ljava/io/ObjectOutput;)V
    ...
    iget v0, p0, Lnet/time4j/SPX;->p:I
