...
# static fields
.field private static final A:Lnet/time4j/f1/j0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/j0<",
            "Lnet/time4j/f;",
...
.field private static final B:Lnet/time4j/f1/j0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/j0<",
            "Lnet/time4j/g;",
...
.field private static final C:Lnet/time4j/f1/j0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/j0<",
            "Lnet/time4j/u;",
...
.field private static final p:Lnet/time4j/n;
...
.field private static final u:Lnet/time4j/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/n$a<",
            "Lnet/time4j/g;",
...
.field private static final v:Lnet/time4j/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/n$a<",
            "Lnet/time4j/g;",
...
.field public static x:Lnet/time4j/f1/d0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/d0<",
            "Lnet/time4j/w;",
...
.field public static y:Lnet/time4j/f1/d0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/d0<",
            "Lnet/time4j/f;",
...
.field public static z:Lnet/time4j/f1/d0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnet/time4j/f1/d0<",
            "Lnet/time4j/g;",
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-char v0, Lnet/time4j/n;->o:C

    new-instance v0, Lnet/time4j/n;

    invoke-direct {v0}, Lnet/time4j/n;-><init>()V

    sput-object v0, Lnet/time4j/n;->p:Lnet/time4j/n;
    ...
    sput-object v2, Lnet/time4j/n;->u:Lnet/time4j/n$a;

    invoke-static {v1}, Lnet/time4j/n;->f(Z)Lnet/time4j/n$a;

    move-result-object v2

    sput-object v2, Lnet/time4j/n;->v:Lnet/time4j/n$a;

    invoke-static {}, Lnet/time4j/o0;->a()Ljava/util/Comparator;

    move-result-object v2

    sput-object v2, Lnet/time4j/n;->w:Ljava/util/Comparator;

    invoke-static {}, Lnet/time4j/o0;->i()Lnet/time4j/o0;

    move-result-object v2

    sput-object v2, Lnet/time4j/n;->x:Lnet/time4j/f1/d0;

    invoke-static {}, Lnet/time4j/o0;->f()Lnet/time4j/o0;

    move-result-object v2

    sput-object v2, Lnet/time4j/n;->y:Lnet/time4j/f1/d0;

    invoke-static {}, Lnet/time4j/o0;->g()Lnet/time4j/o0;

    move-result-object v2

    sput-object v2, Lnet/time4j/n;->z:Lnet/time4j/f1/d0;
    ...
    sget-object v4, Lnet/time4j/f;->v:Lnet/time4j/f;

    const/4 v5, 0x2

    aput-object v4, v3, v5

    invoke-static {v3}, Lnet/time4j/n;->g([Lnet/time4j/w;)Lnet/time4j/f1/j0;

    move-result-object v3

    sput-object v3, Lnet/time4j/n;->A:Lnet/time4j/f1/j0;

    const/4 v3, 0x4

    new-array v3, v3, [Lnet/time4j/g;

    sget-object v6, Lnet/time4j/g;->o:Lnet/time4j/g;
    ...
    sget-object v6, Lnet/time4j/g;->q:Lnet/time4j/g;

    aput-object v6, v3, v5

    sget-object v6, Lnet/time4j/g;->t:Lnet/time4j/g;
    ...
    sput-object v3, Lnet/time4j/n;->B:Lnet/time4j/f1/j0;

    new-array v2, v2, [Lnet/time4j/u;

    invoke-static {}, Lnet/time4j/f;->h()Lnet/time4j/u;
    ...
    invoke-static {v2}, Lnet/time4j/n;->g([Lnet/time4j/w;)Lnet/time4j/f1/j0;

    move-result-object v0

    sput-object v0, Lnet/time4j/n;->C:Lnet/time4j/f1/j0;
...
.method private constructor <init>()V
    ...
    invoke-direct {p0}, Lnet/time4j/f1/a;-><init>()V

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lnet/time4j/n;->D:Ljava/util/List;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lnet/time4j/n;->E:Z
...
.method constructor <init>(Ljava/util/List;Z)V
    ...
    :cond_0
    sget-object v1, Lnet/time4j/n;->w:Ljava/util/Comparator;
    ...
    :goto_0
    iput-object p1, p0, Lnet/time4j/n;->D:Ljava/util/List;
    ...
    :goto_1
    iput-boolean p1, p0, Lnet/time4j/n;->E:Z
...
.method public static varargs g([Lnet/time4j/w;)Lnet/time4j/f1/j0;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U::",
...
.method private h(Lnet/time4j/w;)Z
    ...
    invoke-interface {p1}, Lnet/time4j/w;->d()C
...
.method public static j()Lnet/time4j/n;
    ...
    sget-object v0, Lnet/time4j/n;->p:Lnet/time4j/n;
...
.method private k(I)Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-virtual/range {p0 .. p0}, Lnet/time4j/f1/a;->a()Z
    ...
    check-cast v2, Lnet/time4j/f1/l0$a;

    invoke-virtual {v2}, Lnet/time4j/f1/l0$a;->b()Ljava/lang/Object;
    ...
    invoke-interface {v4}, Lnet/time4j/f1/w;->e()Z
    ...
    :goto_3
    invoke-virtual {v2}, Lnet/time4j/f1/l0$a;->a()J

    move-result-wide v12

    invoke-interface {v4}, Lnet/time4j/w;->d()C

    move-result v2

    move/from16 v19, v14

    sget-object v14, Lnet/time4j/w0;->o:Lnet/time4j/w0;
    ...
    :goto_8
    new-instance v2, Lnet/time4j/f1/r;
    ...
    invoke-direct {v2, v1}, Lnet/time4j/f1/r;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v12, v13, v7, v8}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    :goto_9
    invoke-static {v12, v13, v1, v2}, Lnet/time4j/e1/c;->i(JJ)J
    ...
    invoke-static {v12, v13, v14, v15}, Lnet/time4j/e1/c;->i(JJ)J
    ...
    invoke-static {v13, v14, v6, v7}, Lnet/time4j/e1/c;->f(JJ)J
    ...
    :cond_15
    sget-char v3, Lnet/time4j/n;->o:C
    ...
    check-cast v4, Lnet/time4j/f1/l0$a;

    invoke-virtual {v4}, Lnet/time4j/f1/l0$a;->b()Ljava/lang/Object;

    move-result-object v4

    sget-object v6, Lnet/time4j/w0;->o:Lnet/time4j/w0;

    if-eq v4, v6, :cond_19

    sget-object v6, Lnet/time4j/f;->u:Lnet/time4j/f;
...
.method public b()Ljava/util/List;
    ...
    iget-object v0, p0, Lnet/time4j/n;->D:Ljava/util/List;
...
.method public c(Lnet/time4j/w;)Z
    ...
    iget-object v2, p0, Lnet/time4j/n;->D:Ljava/util/List;
    ...
    iget-object v4, p0, Lnet/time4j/n;->D:Ljava/util/List;
    ...
    :cond_2
    :goto_1
    invoke-virtual {v4}, Lnet/time4j/f1/l0$a;->a()J
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v1, p0, Lnet/time4j/n;->E:Z

    iget-boolean v3, p1, Lnet/time4j/n;->E:Z
...
.method public i()Z
    ...
    iget-boolean v0, p0, Lnet/time4j/n;->E:Z
