...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Le/a/o1/i1$a;->a:Z

    invoke-static {}, Le/a/o1/i1$a;->e()Ljava/lang/RuntimeException;

    move-result-object v0

    sput-object v0, Le/a/o1/i1$a;->b:Ljava/lang/RuntimeException;

    return-void
.end method

.method constructor <init>(Le/a/o1/i1;Le/a/r0;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentMap;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Le/a/o1/i1$a;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/lang/ref/SoftReference;

    sget-boolean v0, Le/a/o1/i1$a;->a:Z
    ...
    :cond_0
    sget-object v0, Le/a/o1/i1$a;->b:Ljava/lang/RuntimeException;

    :goto_0
    invoke-direct {p1, v0}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Le/a/o1/i1$a;->f:Ljava/lang/ref/Reference;

    invoke-virtual {p2}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Le/a/o1/i1$a;->e:Ljava/lang/String;

    iput-object p3, p0, Le/a/o1/i1$a;->c:Ljava/lang/ref/ReferenceQueue;

    iput-object p4, p0, Le/a/o1/i1$a;->d:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {p4, p0, p0}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p3}, Le/a/o1/i1$a;->b(Ljava/lang/ref/ReferenceQueue;)I

    return-void
.end method

.method static synthetic a(Le/a/o1/i1$a;)V
    .locals 0

    invoke-direct {p0}, Le/a/o1/i1$a;->d()V
...
.method static b(Ljava/lang/ref/ReferenceQueue;)I
    ...
    check-cast v2, Le/a/o1/i1$a;

    if-eqz v2, :cond_1

    iget-object v3, v2, Le/a/o1/i1$a;->f:Ljava/lang/ref/Reference;
    ...
    invoke-direct {v2}, Le/a/o1/i1$a;->c()V

    iget-object v4, v2, Le/a/o1/i1$a;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {}, Le/a/o1/i1;->o()Ljava/util/logging/Logger;
    ...
    iget-object v2, v2, Le/a/o1/i1$a;->e:Ljava/lang/String;
...
.method private c()V
    ...
    iget-object v0, p0, Le/a/o1/i1$a;->d:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {v0, p0}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Le/a/o1/i1$a;->f:Ljava/lang/ref/Reference;
...
.method private d()V
    ...
    iget-object v0, p0, Le/a/o1/i1$a;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0}, Le/a/o1/i1$a;->clear()V
...
.method public clear()V
    ...
    invoke-direct {p0}, Le/a/o1/i1$a;->c()V

    iget-object v0, p0, Le/a/o1/i1$a;->c:Ljava/lang/ref/ReferenceQueue;

    invoke-static {v0}, Le/a/o1/i1$a;->b(Ljava/lang/ref/ReferenceQueue;)I
